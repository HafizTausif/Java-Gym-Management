...
public class Payment extends javax.swing.JFrame {
    ...
    public void tableDetails(){
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select * from payment where '"+id+"'");
            while(rs.next()){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            if (rs.next()){
                ...
                ResultSet rs1 = st.executeQuery("select * from payment inner join where payment.Month='"+month+"' and payment.ID='"+id+"' and member.ID = '"+id+"' ");
                while (rs1.next()){
